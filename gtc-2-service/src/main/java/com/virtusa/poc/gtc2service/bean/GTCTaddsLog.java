...
public class GTCTaddsLog {
	...
	public GTCTaddsLog(String deviceId, String headendId, String port, String jobType, String testType,
			String ein, String emsCode, String toggleCode, String testId, Date createdTime, Date modifiedTime,
	...
	public String toString() {
		return "GTCTaddsLog [id=" + id + ", deviceId=" + deviceId + ", headendId=" + headendId + ", port=" + port
				+ ", emsHeadendPort=" + emsHeadendPort + ", jobType=" + jobType + ", testType=" + testType + ", ein="
				+ ein + ", friendlyMsg=" + friendlyMsg + ", emsCode=" + emsCode + ", toggleCode=" + toggleCode
				+ ", testId=" + testId + ", createdTime=" + createdTime + ", modifiedTime=" + modifiedTime
				+ ", startTime=" + startTime + ", endTime=" + endTime + ", operation=" + operation + ", outcome="
				+ outcome + ", faultLocation=" + faultLocation + ", requestFrom=" + requestFrom + "]";
	}
